...
INPUT_CONFS        ?= sky130-files/sky130.yml digital.sky130.yml 
...
extra_v_includes = $(build_dir)/EICG_wrapper.v /tools/B/dan_fritchman/sky130/osci-sky130/caraval_user_project_analog/verilog/rtl/Digital.v
ifneq ($(CUSTOM_VLOG), )
